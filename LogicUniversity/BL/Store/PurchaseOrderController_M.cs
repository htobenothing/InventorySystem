...
namespace BL.Store
{
    public class PurchaseOrderController_M
    {
        ...
        public void NewPurchaseOrderDetail(string orderid,string supid,List<ItemWithQtyModel_M> ItemList)
        {
            try
            {
        ...
        public List<PurchaseOrderTableModel> CreatePurchaseOrderGridView(List<ItemWithQtyModel_M> ItemList)
        {
            List<PurchaseOrderTableModel> table = new List<PurchaseOrderTableModel>();
            foreach(ItemWithQtyModel_M i in ItemList)
            {
        ...
        public void GenerateOrderListByMobile(Dictionary<string,List<ItemWithQtyModel_M>> SupItemMap,string clerkID)
        {
            ...
            if (SupOrderIDMap.ContainsKey("ALPA"))
            {
                ...
                {
                    List<ItemWithQtyModel_M> ALPAList = SupItemMap["ALPA"];
            ...
            if (SupOrderIDMap.ContainsKey("BANE"))
            {
                ...
                {
                    List<ItemWithQtyModel_M> BANEList = SupItemMap["BANE"];
            ...
            if (SupOrderIDMap.ContainsKey("CHEP"))
            {
                ...
                {
                    List<ItemWithQtyModel_M> CHEPList = SupItemMap["CHEP"];
            ...
            if (SupOrderIDMap.ContainsKey("OMEG"))
            {
                ...
                {
                    List<ItemWithQtyModel_M> OMEGList = SupItemMap["OMEG"];
