<%@ Page Title="" Language="C#" MasterPageFile="~/View/StoreClerk/Clerk.Master" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" Inherits="LogicUniversity.View.StoreClerk.ChangePassword" %>
