<%@ Page Title="" Language="C#" MasterPageFile="~/View/Departments/Dept.Master" AutoEventWireup="true" CodeBehind="UpdateProfile.aspx.cs" Inherits="LogicUniversity.View.Departments.UpdateProfile" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="auto-style1">
                <br />
                <asp:TextBox ID="txtph" class="form-control" Width="140" runat="server"></asp:TextBox>
                <asp:RegularExpressionValidator runat="server" ControlToValidate="txtph" ValidationExpression="^\d{8}$" ErrorMessage="Phone Number should be 8 digits" ForeColor="#FF3300"></asp:RegularExpressionValidator>
                </td>
            <td></td>
        </tr>
        <tr>
